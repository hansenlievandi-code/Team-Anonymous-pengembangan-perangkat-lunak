            ...
            <div className="content-container">
              <section id="introduksi">
                ...
                <h3 className="mt-4">Sintaks Python Dibandingkan Bahasa Lain</h3>
                  ...
                  <CodeBlock title="Contoh: Hello World" subtitle={
                    <div className="d-flex gap-3 mb-3">
                      <button className={`btn btn-sm ${selectedLang === 'python' ? 'btn-secondary active' : 'btn-outline-secondary'}`}onClick={() => setSelectedLang('python')}>Python</button>
                      <button className={`btn btn-sm ${selectedLang === 'javascript' ? 'btn-secondary active' : 'btn-outline-secondary'}`}onClick={() => setSelectedLang('javascript')}>JavaScript</button>
                      <button className={`btn btn-sm ${selectedLang === 'java' ? 'btn-secondary active' : 'btn-outline-secondary'}`}onClick={() => setSelectedLang('java')}>Java</button></div>} theme={theme} code={
                  selectedLang === 'python' ? 
                      `# Python
print("Hello, World!")
